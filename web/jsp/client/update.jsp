...
<div id="content-title" style="margin-top: 15px;">
    <h2><fmt:message key="${not empty title ? title : 'title.client.update'}" /></h2>
    <hr>
</div>
<div class="row">
    <div class="col-6">
        <form action="<c:url value="/fc?command=client-update"/>" id="update-client-form" method="POST">
            <h4><fmt:message key="title.client.update" /></h4>
            <c:import url="/jsp/template/form-errors.jsp"/>
            
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="name"/>
                <c:param name="value" value="${client.name}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="surname"/>
                <c:param name="value" value="${client.surname}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="patronymic"/>
                <c:param name="value" value="${client.patronymic}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="email"/>
                <c:param name="value" value="${client.email}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="birthday"/>
                <c:param name="value" value="${client.birthday}"/>
                <c:param name="type" value="datetime-local"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="birthplace"/>
                <c:param name="value" value="${client.birthplace}"/>
            </c:import>
            ...
            <c:import url="/jsp/template/field.jsp">
                ...
                <c:param name="value" value="${client.livingAddress}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="phone.home"/>
                <c:param name="value" value="${client.homePhone}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="phone.mobile"/>
                <c:param name="value" value="${client.mobilePhone}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="work.place"/>
                <c:param name="value" value="${client.workPlace}"/>
            </c:import>
            <c:import url="/jsp/template/field.jsp">
                <c:param name="field" value="work.post"/>
                <c:param name="value" value="${client.post}"/>
            </c:import>
            ...
            <c:import url="/jsp/template/field.jsp">
                ...
                <c:param name="value" value="${client.monthlyEarnings}"/>
    ...
    <div class="col-6 additional">
        ...
        <div class="form-group<c:if test="${errors['client.field.passport.series'] ne null}"> invalid</c:if>">
            ...
            <input type="text" value="${client.passportSeries}" form="update-client-form" name="passport-series" class="form-control" id="passport-series-field" aria-describedby="passport-seriesHelp" placeholder="<fmt:message key="client.field.passport.series.placeholder" />">
        ...
        <div class="form-group<c:if test="${errors['client.field.passport.number'] ne null}"> invalid</c:if>">
            ...
            <input type="text" value="${client.passportNumber}" form="update-client-form" name="passport-number" class="form-control" id="passport-number-field" aria-describedby="passport-numberHelp" placeholder="<fmt:message key="client.field.passport.number.placeholder" />">
        ...
        <div class="form-group<c:if test="${errors['client.field.passport.given.place'] ne null}"> invalid</c:if>">
            ...
            <input type="text" value="${client.passportGivePlace}" form="update-client-form" name="passport-given-place" class="form-control" id="passport-given-place-field" aria-describedby="passport-given-placeHelp" placeholder="<fmt:message key="client.field.passport.given.place.placeholder" />">
        ...
        <div class="form-group<c:if test="${errors['client.field.passport.given.date'] ne null}"> invalid</c:if>">
            ...
            <input type="datetime-local" value="${client.passportGivenDate}" form="update-client-form" name="passport-given-date" class="form-control" id="passport-given-date-field" aria-describedby="passport-given-dateHelp" placeholder="<fmt:message key="client.field.passport.given.date.placeholder" />">
        ...
        <div class="form-group<c:if test="${errors['client.field.identify.number'] ne null}"> invalid</c:if>">
            ...
            <input type="text" value="${client.identifyNumber}" form="update-client-form" name="identify-number" class="form-control" id="identify-number-field" aria-describedby="identify-numberHelp" placeholder="<fmt:message key="client.field.identify.number.placeholder" />">
